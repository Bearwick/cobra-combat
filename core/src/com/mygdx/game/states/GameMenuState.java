...
public class GameMenuState extends State {
    ...
    private static final int playBtnOffset = 50;
    private static final int tutorialBtnOffset = -250;
    private static final int customizeBtnOffset = -550;
    private static final int titleOffset = -160;
    private final Texture background;
    private final Texture playBtn;
    private final Texture tutorialBtn;
    private final Texture customizeBtn;
