...
public class GameMenuState extends State{
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(tutorialBtn, MyGdxGame.WIDTH/2 - (tutorialBtn.getWidth()/2),  200);
        sb.draw(customizeBtn, MyGdxGame.WIDTH/2 - (customizeBtn.getWidth()/2),  100);
        sb.draw(ccText, MyGdxGame.WIDTH/2 - (ccText.getWidth()/2), MyGdxGame.HEIGHT - 80);
        sb.end();
    }
